...
class TestContentProcessorEmailProcessorIntegration(unittest.TestCase):
    ...
    def test_end_to_end_valid_message_processing(self):
        ...
        msg = self.create_test_message(
            subject="Important Business Update", from_addr="colleague@company.com", content=content
        )
...
Please find the attached project timeline for your review."""
    ...
    def test_end_to_end_whitespace_normalization(self):
        ...
        msg = self.create_test_message(
            subject="Messy Formatting", from_addr="user@company.com", content=messy_content
        )
    ...
    def test_end_to_end_batch_processing(self):
        ...
        messages = [
            ...
            self.create_test_message(
                "Auto-Reply: Out of Office", "user2@company.com", "I am out of office"
            ),  # System message
            self.create_test_message(
                "Valid Message 2",
                "user3@company.com",
    ...
    def test_content_duplicate_detection_basic(self):
        ...
        self.create_test_message("subject1", "colleague@company.com", identical_content)
        self.create_test_message(
            "subject2", "colleague@company.com", identical_content
        )  # Different subject, same content
        ...
        self.assertTrue(
            self.content_processor.is_content_duplicate(identical_content, existing_hashes)
        )
    ...
    def test_content_duplicate_with_formatting_differences(self):
        ...
        content2 = (
            "This is an email with extra spaces\nand multiple line breaks for testing purposes."
        )
    ...
    def test_content_duplicate_case_insensitive(self):
        ...
        content1 = (
            "This Is An Email With Different Case Letters For Testing Duplicate Detection Properly."
        )
        content2 = (
            "this is an email with different case letters for testing duplicate detection properly."
        )
...
"""
        ...
        existing_hashes = {hash1}
        self.assertTrue(
            self.content_processor.is_content_duplicate(normalized_content, existing_hashes)
        )

    def test_non_duplicate_content(self):
        """Test that genuinely different content is not detected as duplicate"""
        content1 = (
            "This is the first unique email content for testing purposes with sufficient words."
        )
        content2 = (
            "This is the second unique email content for testing purposes with sufficient words."
        )
    ...
    def test_content_hash_stability(self):
        ...
        content = (
            "This is a test email content for verifying hash stability across multiple generations."
        )
