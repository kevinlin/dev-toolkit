...
class TestCacheIntegration(unittest.TestCase):
    ...
    def test_cache_loading_during_email_processing(self):
        ...
        self.assertTrue(any('Cache loaded: 3 previously processed UIDs' in call for call in print_calls))
    ...
    def test_duplicate_detection_during_processing(self):
        ...
        self.assertEqual(self.mock_imap_manager.fetch_message.call_count, 2)  # Only uid3, uid4 fetched
    ...
    def test_cache_manager_error_handling_in_processor(self):
        ...
        with patch.object(self.cache_manager, 'save_cache', side_effect=Exception("Cache save error")):
            with patch('builtins.print') as mock_print:
                stats = self.email_processor.process_emails()
